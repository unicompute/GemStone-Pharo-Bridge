...
PHARO_IMAGE_VALUE="${PHARO_IMAGE:-/Users/tariq/Documents/Pharo/images/Pharo 13.0 - clean/Pharo 13.0 - clean.image}"
PHARO_WORK_DIR_VALUE="${PHARO_WORK_DIR:-/Users/tariq/Documents/Pharo/images/Pharo 13.0 - clean}"
