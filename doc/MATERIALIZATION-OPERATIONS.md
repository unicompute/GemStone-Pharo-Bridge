...
- Mapped-replicator lifecycle checks that refresh class-version metadata, assert updated server-to-client offsets and clamp levels, and verify live commit/abort paths clear dirty materialized state without discarding the mapped replicator.
