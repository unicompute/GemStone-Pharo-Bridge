...
- `make replication-live` validates connector install, server clamp synchronization, clamped traversal, native dirty-store flush, a twelve-object business-write dirty traversal fixture, export-set queue acknowledgement, and trend thresholds against a live GemStone session.
